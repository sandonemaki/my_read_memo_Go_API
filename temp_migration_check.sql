...
-- +goose Down
-- +goose StatementBegin
DROP TABLE IF EXISTS kindle_highlights;
DROP TABLE IF EXISTS ocr_texts;
DROP TABLE IF EXISTS reading_history;
DROP TABLE IF EXISTS seidoku_memos;
DROP TABLE IF EXISTS randoku_memos;
DROP TABLE IF EXISTS randoku_images;
DROP TABLE IF EXISTS user_book_logs;
